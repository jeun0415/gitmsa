...
--
-- Host: localhost    Database: madanguniv
-- ------------------------------------------------------
...
CREATE TABLE `workdept` (
  ...
  KEY `p_ssn` (`p_ssn`),
  CONSTRAINT `workdept_ibfk_1` FOREIGN KEY (`dno`) REFERENCES `department` (`dno`),
  CONSTRAINT `workdept_ibfk_2` FOREIGN KEY (`p_ssn`) REFERENCES `professor` (`p_ssn`)
