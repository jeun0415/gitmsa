    ...
    <div class="min-h-screen bg-gray-100 flex items-center justify-center">
        ...
        <form @submit.prevent="doSubmit">
            ...
            <div class="mb-4">
                ...
                value="aaa@naver.com"
                class="mt-1 p-2 border border-gray-300 rounded w-full" placeholder="이메일을 입력하세요">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                value="1234"
                class="mt-1 p-2 border border-gray-300 rounded w-full" placeholder="비밀번호를 다시 입력하세요">
            </div>
            <button type="submit" 
                    class="w-full bg-blue-600 text-white p-2 rounded hover:bg-blue-700">회원가입</button>
        </form>
        <p class="mt-4 text-center text-sm text-gray-600">이미 계정이 있으신가요? <a href="#" @click="zz" class="text-blue-600 hover:underline">로그인</a></p>
    </div>
    </div>
</template>
